                ...
                if ($query) {
                  while ($row = mysqli_fetch_assoc($query)) {
                    ...
                    echo "<tr>
                            ...
                            if ($row['status'] == "1") {
                                echo "<a href='deactivate.php?deactivateId=" . $row['Id'] . "' class='btn btn-sm w-100 d-flex align-items-center justify-content-center glow-btn-2'>Unpaid</a>";
                            } else {
                                echo "<a href='activate.php?activateId=" . $row['Id'] . "' class='btn btn-sm w-100 d-flex align-items-center justify-content-center glow-btn'>Paid</a>";
                            }
                            echo "</td> 
                            </tr>";
                  }
